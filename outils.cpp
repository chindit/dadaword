...
void Outils::fenetre_config(){
    ...
    //Contenu
    QLabel *titre_config, *affiche_outils, *affiche_taille_police, *affiche_nom_police, *label_fichiers_vides, *label_alertes, *label_base64, *label_word, *label_dicos;
    ...
    layout_config->addWidget(label_word, 4, 0, 1, 1);
    layout_config->addWidget(checkbox_word, 4, 1, 1, 1);
