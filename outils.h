...
private:
    ...
    QCheckBox *checkbox_onglets, *checkbox_fichiers_vides, *checkbox_word, *checkbox_orthographe, *checkbox_orthographe_texte, *checkbox_autocorrection, *checkbox_icons, *checkbox_titre, *checkbox_dir;
